...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            #get 5 year survival time for this cohort
            cohort_5_year_survival = multiCohort.get_cohort_5_yr_survival(cohort_id)

            # construct a likelihood
            # with 5-yr-survival calculated from the simulated data.
            # evaluate this pmf (probability mass function) at the 5 yr survival rate reported in the clinical study.
            weight = stat.binom.pmf(
                k=CalibSets.OBS_Survived_5_years,
                n=CalibSets.OBS_Total_N,
                p=cohort_5_year_survival)
